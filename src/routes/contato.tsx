...
export const Route = createFileRoute("/contato")({
  head: () => ({
    meta: [
      { title: "Contato — Costa Veículos" },
      { name: "description", content: `Endereço, telefone e horário de atendimento da Costa Veículos em Cachoeira de Minas - MG.` },
      { property: "og:title", content: "Contato — Costa Veículos" },
    ],
  }),
  component: Contato,
});
