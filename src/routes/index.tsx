...
const DEMO_VEHICLES: ReadonlyArray<{ id: string; brand: string; model: string; year: number; mileage: number; price: number; fuel: string; category: string; img: string; tag?: string }> = [
  ...
  { id: "d5", brand: "Chevrolet", model: "Onix Premier", year: 2023, mileage: 19800, price: 89900, fuel: "Flex", category: "Hatch", img: "https://images.unsplash.com/photo-1568844293986-8d0400bd4745?auto=format&fit=crop&w=1200&q=80", tag: "Baixa quilometragem" },
